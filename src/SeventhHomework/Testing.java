...
public class Testing {
        ...
        public static void main(String[] args) {
            start(SolutionTest.class);
            clear();
            start(SolutionTest.class.getName());
        }
        ...
        private static void fillMethods(Class tClass) {
            ...
            for (Method o : methods) {
                ...
                if (o.getAnnotation(BeforeSuite.class) != null) beforeSuitList.add(o);
                    ...
                    methodsHashMap.put(o, o.getAnnotation(Test.class).priority());
            }
        ...
        public static void doMethods(Class tClass) throws InstantiationException {
            ...
            String str = "iii";
            try {
                SolutionTest testInstance = (SolutionTest) tClass.newInstance();
